...
def generate_flowchart(output: Path) -> None:
    ...
    ax.add_patch(
        Rectangle((0.01, 0.01), 0.98, 0.98, fill=False, linewidth=1.2, edgecolor='#2b2b2b')
    )
    ax.add_patch(
        Rectangle((0.01, 0.92), 0.98, 0.07, fill=False, linewidth=1.0, edgecolor='#2b2b2b')
    )
    ...
    add_text(
        ...
        0.355,
        0.965,
        'БЛОК-СХЕМА АЛГОРИТМА РАБОТЫ ПРИЛОЖЕНИЯ «МАГАЗИН ОБУВИ»',
        fontsize=16,
        weight='bold',
    )
    add_text(
        ...
        0.355,
        0.936,
        'Модуль 2. Разработка алгоритма и создание приложения. Оформлено по ГОСТ 19.701-90.',
        fontsize=10.5,
    )
    ...
    for x, title in [
        (0.08, 'Инициализация'),
        (0.31, 'Авторизация и роль'),
        (0.56, 'Работа с товарами'),
        (0.83, 'Работа с заказами / завершение'),
    ]:
        ax.add_patch(
            Rectangle(
                (x - 0.10, 0.865),
    ...
    draw_process(
        ax, 0.02, y_top - 5.28 * gap, 0.16, 0.06, 'Вывод сообщения об ошибке\nи запись в журнал'
    )
    ...
    arrow(
        ax, 0.10, y_top - 4.22 * gap, 0.10, y_top - 5.28 * gap + 0.06, label='Нет', label_dx=-0.03
    )
    ...
    draw_process(
        ax, 0.225, y_top - 6.20 * gap, 0.18, 0.06, 'Открытие главного окна\nс правами роли'
    )
    ...
    elbow(
        ax,
        [
            (0.155, y_top - 4.22 * gap + 0.04),
            (0.205, y_top - 4.22 * gap + 0.04),
            (0.205, y_top - gap + 0.04),
            (0.255, y_top - gap + 0.04),
        ],
        label='Да',
        label_pos=(0.205, y_top - gap + 0.065),
    )
    ...
    arrow(
        ax, 0.315, y_top - 4.10 * gap, 0.315, y_top - 5.22 * gap + 0.06, label='Да', label_dx=-0.045
    )
    ...
    elbow(
        ax,
        [
            (0.405, y_top - 4.10 * gap + 0.04),
            (0.405, y_top - 7.20 * gap + 0.03),
            (0.405, y_top - 7.20 * gap + 0.03),
        ],
    )
    ...
    draw_process(
        ax, 0.47, y_top - 5.28 * gap, 0.20, 0.06, 'Добавление / редактирование /\nудаление товара'
    )
    draw_decision(ax, 0.515, y_top - 6.35 * gap, 0.11, 0.08, 'Данные товара\nкорректны?')
    draw_process(
        ax, 0.475, y_top - 7.42 * gap, 0.19, 0.06, 'Сохранение изменений:\nБД + путь к изображению'
    )
    draw_process(
        ax,
        0.475,
    ...
    elbow(
        ax,
        [
            (0.405, y_top - 6.20 * gap + 0.03),
            (0.445, y_top - 6.20 * gap + 0.03),
            (0.445, y_top - 0.02 + 0.027),
            (0.49, y_top - 0.02 + 0.027),
        ],
    )
    elbow(
        ax,
        [
            (0.405, y_top - 2 * gap + 0.03),
            (0.445, y_top - 2 * gap + 0.03),
            (0.445, y_top - 0.02 + 0.027),
            (0.49, y_top - 0.02 + 0.027),
        ],
    )
    ...
    arrow(
        ax, 0.57, y_top - 2.07 * gap, 0.57, y_top - 3.15 * gap + 0.06, label='Да', label_dx=-0.045
    )
    elbow(
        ax,
        [
            (0.625, y_top - 2.07 * gap + 0.04),
            (0.67, y_top - 2.07 * gap + 0.04),
            (0.67, y_top - 8.42 * gap + 0.03),
            (0.665, y_top - 8.42 * gap + 0.03),
        ],
        label='Нет',
        label_pos=(0.66, y_top - 2.07 * gap + 0.07),
    )
    arrow(ax, 0.57, y_top - 3.15 * gap, 0.57, y_top - 4.20 * gap + 0.08)
    arrow(
        ax, 0.57, y_top - 4.20 * gap, 0.57, y_top - 5.28 * gap + 0.06, label='Да', label_dx=-0.045
    )
    elbow(
        ax,
        [
            (0.625, y_top - 4.20 * gap + 0.04),
            (0.69, y_top - 4.20 * gap + 0.04),
            (0.69, y_top - 8.42 * gap + 0.03),
            (0.665, y_top - 8.42 * gap + 0.03),
        ],
        label='Нет',
        label_pos=(0.685, y_top - 4.20 * gap + 0.07),
    )
    arrow(ax, 0.57, y_top - 5.28 * gap, 0.57, y_top - 6.35 * gap + 0.08)
    arrow(
        ax, 0.57, y_top - 6.35 * gap, 0.57, y_top - 7.42 * gap + 0.06, label='Да', label_dx=-0.045
    )
    elbow(
        ax,
        [
            (0.625, y_top - 6.35 * gap + 0.04),
            (0.68, y_top - 6.35 * gap + 0.04),
            (0.68, y_top - 7.20 * gap + 0.03),
            (0.405, y_top - 7.20 * gap + 0.03),
        ],
        label='Нет',
        label_pos=(0.665, y_top - 6.35 * gap + 0.07),
    )
    ...
    draw_data(
        ax, 0.735, y_top - gap - 0.01, 0.18, 0.055, 'Получение заказов,\nстатусов и ПВЗ из БД'
    )
    ...
    elbow(
        ...
        [
            (0.665, y_top - 8.42 * gap + 0.03),
            (0.705, y_top - 8.42 * gap + 0.03),
            (0.705, y_top - 0.02 + 0.04),
            (0.77, y_top - 0.02 + 0.04),
        ],
    )
    arrow(
        ax,
    ...
    elbow(
        ax,
        [
            (0.88, y_top - 0.02 + 0.04),
            (0.94, y_top - 0.02 + 0.04),
            (0.94, y_top - 7.38 * gap + 0.04),
            (0.88, y_top - 7.38 * gap + 0.04),
        ],
        label='Нет',
        label_pos=(0.935, y_top - 0.02 + 0.07),
    )
    arrow(ax, 0.825, y_top - gap - 0.01, 0.825, y_top - 2.0 * gap + 0.06)
    arrow(ax, 0.825, y_top - 2.0 * gap, 0.825, y_top - 3.05 * gap + 0.08)
    arrow(
        ax, 0.825, y_top - 3.05 * gap, 0.825, y_top - 4.15 * gap + 0.06, label='Да', label_dx=-0.045
    )
    elbow(
        ax,
        [
            (0.88, y_top - 3.05 * gap + 0.04),
            (0.93, y_top - 3.05 * gap + 0.04),
            (0.93, y_top - 7.38 * gap + 0.04),
            (0.88, y_top - 7.38 * gap + 0.04),
        ],
        label='Нет',
        label_pos=(0.925, y_top - 3.05 * gap + 0.07),
    )
    arrow(ax, 0.825, y_top - 4.15 * gap, 0.825, y_top - 5.22 * gap + 0.08)
    arrow(
        ax, 0.825, y_top - 5.22 * gap, 0.825, y_top - 6.30 * gap + 0.06, label='Да', label_dx=-0.045
    )
    elbow(
        ax,
        [
            (0.88, y_top - 5.22 * gap + 0.04),
            (0.93, y_top - 5.22 * gap + 0.04),
            (0.93, y_top - 7.38 * gap + 0.04),
            (0.88, y_top - 7.38 * gap + 0.04),
        ],
        label='Нет',
        label_pos=(0.925, y_top - 5.22 * gap + 0.07),
    )
    arrow(ax, 0.825, y_top - 6.30 * gap, 0.825, y_top - 7.38 * gap + 0.08)
    arrow(
        ax, 0.825, y_top - 7.38 * gap, 0.825, y_top - 8.38 * gap + 0.045, label='Да', label_dx=-0.04
    )

    # legend block
    ax.add_patch(
        Rectangle((0.02, 0.03), 0.43, 0.12, fill=False, linewidth=1.0, edgecolor='#2b2b2b')
    )
...
def draw_entity(ax, entity: Entity):
    ...
    ax.add_patch(
        Rectangle(
            (entity.x, entity.y + entity.h - 0.05),
            entity.w,
            0.05,
            facecolor='#2f5aa6',
            edgecolor='#2f5aa6',
...
def generate_er(output: Path) -> None:
    ...
    ax.text(
        0.02,
        0.97,
        'ER-диаграмма БД ИС «Магазин обуви»',
        fontsize=22,
        weight='bold',
        ha='left',
        va='top',
    ...
    ax.text(
        0.02,
        0.92,
        'Диаграмма отражает роли пользователей, каталог товаров, заказы и связанные справочники.',
        fontsize=11.5,
        ha='left',
        va='top',
    )
    ...
    entities = {
        ...
        'users': Entity(
            'users',
            ['PK id', 'FK role_id', 'full_name', 'login', 'password'],
            0.00,
            0.41,
            0.22,
            0.18,
        ...
        'items': Entity(
            'order_items',
            ['PK id', 'FK order_id', 'FK product_id', 'quantity'],
            1.02,
            0.02,
            0.22,
            0.16,
